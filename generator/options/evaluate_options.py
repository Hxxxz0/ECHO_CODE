...
class TestOptions():
    ...
    def initialize(self):
        self.parser.add_argument("--opt_path", type=str, default='./checkpoints/robotv2/robotv2_38d/opt.txt', help='option file path for loading model')
        self.parser.add_argument("--gpu_id", type=int, default=7, help='GPU id')

        # evaluator
        self.parser.add_argument("--evaluator_dir", type=str, default='./checkpoints/robot_evaluator', help='Directory path for MoCLIP evaluator checkpoint')
        self.parser.add_argument("--eval_meta_dir", type=str, default='./data', help='Directory path for evaluation normalization data.')
    ...
    def parse(self):
        ...
        # load the model options of MoCLIP evaluator
